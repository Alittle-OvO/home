...
<html>
	...
	function judge(){		
		...
		var sex=$("#sex1").val();
		var tel=$("#tel1").val();
		if(username==""||pwd==""||repwd==""||name==""||sex=="请选择"||tel==""){
		  	alert("请检查是否填写完整！");
			return false;
		}
		if(isNaN(tel)){
	...
	<body>
		...
		<table class="b_table">
			...
			<tr>
				...
				<td bgcolor="#F6F9FE">						
					<div>
						<form action="Add_Manager" method="post" onsubmit="return judge()">
							<table class="m_table"  cellspacing="0" cellpadding="0">	
								...
								<tr  class="therow">
									...
									<td><input type="text" id="tel1" name="tel"></td>									
								</tr>
								<tr height="5px">
									<td></td>
								</tr>
								<tr class="therow">
									<td class="bt"colspan="2">
										<input type="submit"  id="addtd"  name="add" value="添加楼宇管理员">
