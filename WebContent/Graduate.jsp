	...
	<body>
		<table class="b_table">
			...
			<tr>
				...
				<td bgcolor="#F6F9FE">						
					<div>
						<form action="Graduated" method="post">
						<table class="m_table"  cellspacing="0" cellpadding="0">	
							...
							<tr height="40px" align="center" >
								<td colspan="2">
									<span style="color: red"><h4>此功能只适用于毕业的学生迁出，迁出后不可恢复，确定要迁出该学生吗？</h4></span>
								</td>
							</tr>
							<tr class="therow" id="rowtop">
								...
								<td class="msg">
									<input type="hidden" name="username" value="<%= request.getAttribute("student_username") %>">
									<input type="hidden" name="sid" value="<%= request.getAttribute("student_id") %>">
									<%=request.getAttribute("student_username") %>
								</td>									
							</tr>							
							<tr  class="therow">
								<td class="word">
							...
							<tr  class="therow">
								...
								<td class="msg">
									<%=request.getAttribute("student_sex") %>
								</td>									
							</tr>
							<tr  class="therow">
								<td class="word">
							...
							<tr class="therow">
								...
								<td class="msg">
									<textarea rows="6" cols="35" name="area"></textarea>
								</td>
							</tr>									
							...
							<tr class="therow">
								<td class="bt"colspan="2">
									<input type="submit"  id="addtd"  name="add" value="确定迁出">
