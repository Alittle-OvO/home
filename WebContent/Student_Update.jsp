...
<html>
	...
	<body>
		...
		<%
			 int id = Integer.parseInt(request.getAttribute("student_id").toString()); 
		...
		<table class="b_table">
			...
			<tr>
				...
				<td bgcolor="#F6F9FE">						
					<div>
						<form action="Update_Student" method="post" onsubmit="return judge()">
						<table class="m_table"  cellspacing="0" cellpadding="0">	
							...
							<tr class="therow" id="rowtop">
								...
								<td>
									...
									<input type="text" id="sid1" name="sid" value="<%= list.get(0).getStudent_Username() %>">
								</td>									
							</tr>
							<tr  class="therow">
								<td class="word">
							...
							<tr  class="therow">
								...
								<td><input type="text" id="name1" name="name" value="<%= list.get(0).getStudent_Name()%>"></td>									
							</tr>
							<tr  class="therow">
								<td class="word">
									<span class="red">*</span>
								...
								<td>
									<select id="sex1" name="sex">
										<option value="<%= list.get(0).getStudent_Sex()%>">
							...
							<tr  class="therow">
								...
								<td><input type="text" id="classes" name="classes" value="<%= list.get(0).getStudent_Class()%>"></td>									
							</tr>
							<tr height="5px">
								<td></td>
							</tr>
							<tr class="therow">
								<td class="bt"colspan="2">
									<input type="submit"  id="addtd"  name="add" value="修改学生">
