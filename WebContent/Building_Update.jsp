...
<html>
	...
	<body>
		...
		<%
			 int id = Integer.parseInt(request.getAttribute("building_id").toString()); 
			
			List<Building> list = (List<Building>)request.getAttribute("list");
			if(list==null){
				list = new UpdateMassage().getBuildingListById(id);
			}	
		%>
		...
		<table class="b_table">
			...
			<tr>
				...
				<td bgcolor="#F6F9FE">						
					<div>
					<form action="Update_Building" onsubmit="return judge()">
						<table class="m_table"  cellspacing="0" cellpadding="0">	
							...
							<tr class="therow" id="rowtop">
								...
								<td>
									<input type="hidden" name="uid" value="<%=list.get(0).getBuilding_ID() %>"> 
									<input type="text" id="building_name" name="building_name" value="<%=list.get(0).getBuilding_Name() %>">
								</td>									
							</tr>
							<tr class="therow">
								<td height="100px"></td>
								...
								<td>
									<textarea rows="6" cols="40" id="area" name="area"><%=list.get(0).getBuilding_Introduction()%></textarea>
								</td>									
							</tr>					
							<tr height="5px">
								<td></td>
							...
							<tr class="therow">
								...
								<td class="bt"colspan="3" align="center">
									<input type="submit"  id="addtd"  name="add" value="修改楼宇">
