...
<html>
	...
	<body>
		...
		<%
			 int id = Integer.parseInt(request.getAttribute("dormitory_id").toString()); 
			
			List<Building_Dormitory> list2 = (List<Building_Dormitory>)request.getAttribute("list");
			if(list2==null){
				list2 = new UpdateMassage().getDormitoryListById(id);
			}	
		%>
		...
		<table class="b_table">
			...
			<tr>
				...
				<td bgcolor="#F6F9FE">						
					<div>
						<form action="Update_Dormitory"  method="post" onsubmit="return check()">
							<table class="m_table"  cellspacing="0" cellpadding="0">	
								...
								<tr class="therow" id="rowtop">
									...
									<td>
										<input type="hidden" name="uid" value="<%=list2.get(0).getDormitory_ID()%>">
										<select  id="building_name" name="building_name">
											<option value="<%=list2.get(0).getDormitory_BuildingID() %>">
												<%=list2.get(0).getBuilding_Name() %>
											</option>
								...
								<tr  class="therow">
									...
									<td><input type="text" id="did" name="did" value="<%=list2.get(0).getDormitory_Name() %>"></td>									
								</tr>
								<tr  class="therow">
									<td class="word">
										<span class="red">*</span>
									...
									<td><input type="text" id="type" name="type" value="<%=list2.get(0).getDormitory_Type() %>"></td>									
								</tr>
								<tr  class="therow">
									<td class="word">
										<span class="red">*</span>
									...
									<td><input type="text" id="number" name="number" value="<%=list2.get(0).getDormitory_Number() %>"></td>									
								</tr>
								<tr  class="therow">
									<td class="word">
										<span class="red">*</span>
									...
									<td><input type="text" id="tel" name="tel" value="<%=list2.get(0).getDormitory_Tel() %>"></td>									
								</tr>
								<tr height="5px">
									<td></td>
								</tr>
								<tr class="therow">
									<td class="bt"colspan="2">
										<input type="submit"  id="addtd"  name="add" value="修改宿舍">
